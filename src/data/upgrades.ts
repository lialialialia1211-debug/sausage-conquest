...
export const CART_UPGRADES: CartUpgrade[] = [
  ...
  { id: 'mini-fridge', name: '迷你冰箱', emoji: '❄️', image: 'upgrade-mini-fridge.png', cost: 800, description: '隔夜損耗降為 10%', effect: { spoilReduction: 0.1 } },
...
export const MARKETING_ITEMS: MarketingItem[] = [
  ...
  { id: 'discount-sign', name: '特價牌', emoji: '🏷️', image: 'marketing-discount-sign.png', cost: 30, description: '購買率 +15%', effect: { buyRate: 0.15 } },
